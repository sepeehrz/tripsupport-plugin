...
<template>
  <section>
    ...
    <DropdownDialog :showMenu="travellersMenu">
      <template #data>
        <div class="wrapper" v-click-outside="outSideTravellersMenu">
          <div class="ts-traveller-error" v-if="getRoomsError">
            Sorry, You cannot book children with multiple rooms
          </div>
          <div class="ts-traveller-error" v-if="getErrorPassengers">
          ...
          >
            <div class="ts-counter-wrapper">
              ...
              <div class="ts-counter-buttons-wrapper">
                ...
                <button
                  @click="childItemPlus(item)"
                  class="ts-counter-buttons"
                  :disabled="item.child >= 17"
                >
                  +
                </button>
              </div>
        ...
        <div class="ts-done">
          <button
            :disabled="getErrorPassengers || getRoomsError || getChildAgeError"
            @click="done"
          >
            {{ $t('Done') }}
          </button>
